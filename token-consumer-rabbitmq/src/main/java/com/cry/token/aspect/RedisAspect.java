...
public class RedisAspect {
     ...
     */
    @Pointcut("@annotation(com.cry.token.annotation.RedisCache)||@within(com.cry.token.annotation.RedisCache)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws ClassNotFoundException {
        ...
        Object obj = redisCache.getDataFromRedis(redisKey, ClassNameUtils.reflectClassName(className));
