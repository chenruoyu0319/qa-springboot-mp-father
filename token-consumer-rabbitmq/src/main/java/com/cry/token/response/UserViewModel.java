...
import com.cry.token.request.AddUserReq;
import com.cry.token.request.LoginRequest;
 ...
 */
@ApiModel(value = "com.cry.token.response.UserViewModel", description = "用户视图封装类")
@Data
@NoArgsConstructor
@AllArgsConstructor
